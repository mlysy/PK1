...
namespace model_PK1_Mixed_SDE_Pure_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_PK1_Mixed_SDE_Pure");
    ...
    reader.add_event(48, 21, "restart", "model_PK1_Mixed_SDE_Pure");
    reader.add_event(121, 92, "end", "model_PK1_Mixed_SDE_Pure");
    return reader;
}
...
#include <stan_meta_header.hpp>
 class model_PK1_Mixed_SDE_Pure : public prob_grad {
private:
    int nObs;
    int nSub;
...
public:
    model_PK1_Mixed_SDE_Pure(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_PK1_Mixed_SDE_Pure_namespace::model_PK1_Mixed_SDE_Pure";
        ...
        try {
            ...
            for (int jj = 1; jj <= (nObs - 1); ++jj) {
                ...
                for (int ii = 1; ii <= nSub; ++ii) {
                    ...
                    stan::model::assign(Xt, 
                                stan::model::cons_list(stan::model::index_uni(ii), stan::model::cons_list(stan::model::index_uni(jj), stan::model::nil_index_list())), 
                                get_base1(get_base1(Yt,ii,"Yt",1),jj,"Yt",2), 
            ...
            for (int ii = 1; ii <= nSub; ++ii) {
                ...
                stan::model::assign(Xt, 
                            stan::model::cons_list(stan::model::index_uni(ii), stan::model::cons_list(stan::model::index_uni(nObs), stan::model::nil_index_list())), 
                            get_base1(get_base1(Yt,ii,"Yt",1),nObs,"Yt",2), 
                            "assigning variable Xt");
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_PK1_Mixed_SDE_Pure_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    static std::string model_name() {
        return "model_PK1_Mixed_SDE_Pure";
    }
...
typedef model_PK1_Mixed_SDE_Pure_namespace::model_PK1_Mixed_SDE_Pure stan_model;

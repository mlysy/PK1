...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(102, 102, "end", "model_PK1_Fixed_ODE_Noise");
    return reader;
}
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            for (int ii = 1; ii <= nSub; ++ii) {
                ...
                stan::math::assign(get_base1_lhs(Xt,ii,"Xt",1), to_array_1d(PK1_ODE(get_base1(D,ii,"D",1),Cl,Ka,Ke,get_base1(t,ii,"t",1), pstream__)));
            }

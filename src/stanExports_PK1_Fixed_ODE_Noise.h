...
namespace model_PK1_Fixed_ODE_Noise_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_PK1_Fixed_ODE_Noise");
    ...
    reader.add_event(48, 21, "restart", "model_PK1_Fixed_ODE_Noise");
    reader.add_event(104, 75, "end", "model_PK1_Fixed_ODE_Noise");
    return reader;
}
...
#include <stan_meta_header.hpp>
 class model_PK1_Fixed_ODE_Noise : public prob_grad {
private:
    int nObs;
    int nSub;
...
public:
    model_PK1_Fixed_ODE_Noise(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_PK1_Fixed_ODE_Noise_namespace::model_PK1_Fixed_ODE_Noise";
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            vector<vector<local_scalar_t__> > Xt(nSub, (vector<local_scalar_t__>(nObs)));
            ...
            for (int ii = 1; ii <= nSub; ++ii) {
                ...
                stan::model::assign(Xt, 
                            ...
                            to_array_1d(PK1_ODE(get_base1(D,ii,"D",1),Cl,Ka,Ke,get_base1(t,ii,"t",1), pstream__)), 
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_PK1_Fixed_ODE_Noise_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    static std::string model_name() {
        return "model_PK1_Fixed_ODE_Noise";
    }
...
typedef model_PK1_Fixed_ODE_Noise_namespace::model_PK1_Fixed_ODE_Noise stan_model;

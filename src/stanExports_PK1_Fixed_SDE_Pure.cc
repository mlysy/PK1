...
#include "stanExports_PK1_Fixed_SDE_Pure.h"

RCPP_MODULE(stan_fit4PK1_Fixed_SDE_Pure_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_PK1_Fixed_SDE_Pure")

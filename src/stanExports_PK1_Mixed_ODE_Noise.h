...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(48, 21, "restart", "model_PK1_Mixed_ODE_Noise");
    reader.add_event(120, 91, "end", "model_PK1_Mixed_ODE_Noise");
    return reader;
}
        ...
        try {
            ...
            for (int ii = 1; ii <= nSub; ++ii) {
                ...
                stan::model::assign(Xt, 
                            ...
                            to_array_1d(PK1_ODE(get_base1(D,ii,"D",1),get_base1(Cl,ii,"Cl",1),get_base1(Ka,ii,"Ka",1),get_base1(Ke,ii,"Ke",1),get_base1(t,ii,"t",1), pstream__)), 
